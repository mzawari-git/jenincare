...
class USBCameraManager @Inject constructor(
    ...
    private var imageChannel: Channel<Bitmap> = Channel(Channel.UNLIMITED)
    ...
    suspend fun openCamera(cameraId: String, surface: Surface? = null): CameraDevice =
        suspendCancellableCoroutine { continuation ->
            ...
            imageChannel = Channel(Channel.UNLIMITED)
                    ...
                    override fun onOpened(camera: CameraDevice) {
                        ...
                        if (ps != null) {
                            try {
                                ...
                                imageReader = ImageReader.newInstance(size.width, size.height, ImageFormat.JPEG, 4).apply {
                                        ...
                                        if (image != null) {
                                            try {
                                                ...
                                                if (bitmap != null) {
                                                    ...
                                                    Timber.d("captureFrame: ${bitmap.width}x${bitmap.height}, orientation=$orientation")
                                                    if (orientation != 0) {
