...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideFiseGpioController(): FiseGpioController {
        return FiseGpioController()
    }
    ...
    fun provideFrameCapturePipeline(
        ...
        return FrameCapturePipeline(spectrumController, cameraManager, serialBusManager, faceDetector, fiseGpioController)
    }
