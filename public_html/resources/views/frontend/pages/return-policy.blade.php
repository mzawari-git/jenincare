...
@section('meta_description', 'سياسة الإرجاع والاستبدال الخاصة بشركة جنين للتجميل. تعرف على الشروط والأحكام والإطار الزمني لإرجاع واستبدال منتجات العناية بالبشرة والتجميل.')
        ...
        <div class="col-lg-9">
            ...
            <div class="policy-section">
                <p class="lead" style="color: #4B5563; font-size: 1.1rem;">
                    نحن في <strong>{{ $siteSettings['site_name'] ?? 'شركة جنين للتجميل' }}</strong> نضع رضا عملائنا في مقدمة أولوياتنا. ولأننا نتعامل مع مستحضرات التجميل والعناية بالبشرة، فإننا نلتزم بأعلى معايير الصحة والسلامة العامة، وبما يتوافق تماماً مع قانون حماية المستهلك الفلسطيني.
                </p>
