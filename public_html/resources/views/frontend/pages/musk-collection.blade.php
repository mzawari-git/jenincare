...
<body class="bg-[#FAF9F6] text-gray-800 antialiased">
    ...
    <div id="loading-page">
        ...
        <div class="text-2xl font-bold tracking-widest font-serif mb-4">
            <span class="gradient-text">NOVA</span>
        </div>
        <div class="loader-stars text-nova-gold text-lg mb-4">
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            const messages = [
                'جاري تحميل المجموعة الملكية...',
                'تجهيز أجود مكونات العناية...',
                'إضافة لمسات المسك الفاخرة...',
                'تجربة الجمال في الطريق إليكِ...'
            ];
            ...
            const interval = setInterval(() => {
                ...
                const msgIndex = Math.min(Math.floor(progress / 30), messages.length - 1);
