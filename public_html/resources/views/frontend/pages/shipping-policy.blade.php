...
@section('title', 'سياسة الشحن والتوصيل - ' . ($siteSettings['site_name'] ?? 'شركة جنين للتجميل'))

@section('meta_description', 'سياسة الشحن والتوصيل الخاصة بشركة جنين للتجميل. تعرف على مناطق التغطية، أوقات التوصيل، والتكاليف في فلسطين.')
        ...
        <div class="col-lg-9">
            ...
            <div class="policy-section">
                <p class="lead" style="color: #4B5563; font-size: 1.1rem;">
                    نحن في <strong>{{ $siteSettings['site_name'] ?? 'شركة جنين للتجميل' }}</strong> ندرك أنكِ تترقبين وصول منتجات العناية والتجميل الخاصة بكِ بشغف. لذلك، قمنا ببناء شبكة لوجستية متطورة تضمن وصول طلباتكِ بسرعة، وأمان، وبأعلى معايير الجودة الممكنة.
                </p>
            </div>
