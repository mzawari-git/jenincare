...
@section('title', 'الشروط والأحكام - ' . ($siteSettings['site_name'] ?? 'شركة جنين للتجميل'))

@section('meta_description', 'الشروط والأحكام القانونية لاستخدام منصة شركة جنين للتجميل. اقرأ الوثيقة القانونية قبل إتمام أي عملية شراء.')
        ...
        <div class="col-lg-9">
            ...
            <div class="terms-section">
                <p class="lead" style="color: #4B5563; font-size: 1.1rem; text-align: center; font-weight: 600;">
                    مرحباً بكم في منصة {{ $siteSettings['site_name'] ?? 'شركة جنين للتجميل' }}. تُشكل هذه الصفحة وثيقة قانونية بالغة الأهمية تنظم علاقتكم بمنصتنا. يرجى قراءتها بعناية قبل البدء باستخدام الموقع أو إتمام أي عملية شراء.
                </p>
            </div>
            ...
            <div class="terms-section" id="section1">
                ...
                <p>تُعد هذه الشروط والأحكام بمثابة اتفاقية قانونية ملزمة تماماً بين "{{ $siteSettings['site_name'] ?? 'شركة جنين للتجميل' }}" (يُشار إليها لاحقاً بـ "الشركة" أو "المنصة") وبين المستخدم (سواء كان متسوقاً فرداً أو جهة تجارية).</p>
            ...
            <div class="terms-section" id="section5">
                ...
                <p>إن جميع المحتويات المتاحة على المنصة، بما في ذلك النصوص، الصور، الفيديوهات، العلامات التجارية، الشعارات، وتصميم واجهة المستخدم باللغة العربية (RTL)، هي ملكية فكرية حصرية لـ "{{ $siteSettings['site_name'] ?? 'شركة جنين للتجميل' }}" ومحمية بموجب قوانين حقوق الطبع والنشر.</p>
