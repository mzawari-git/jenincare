...
<section class="py-16 relative overflow-hidden" style="border-top:2px solid var(--glass-border);">
    <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
        <h2 class="text-2xl md:text-3xl font-black mb-3" style="color:var(--brand-500);">انضمي إلى نادي {{ $siteSettings['site_name'] ?? 'شركة جنين للتجميل' }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
            ...
            <div class="lg:col-span-4 text-right">
                ...
                <p class="text-ink-dim text-sm leading-relaxed mb-6 max-w-sm ml-auto">
                    {{ $siteSettings['site_description'] ?? 'منتجات تجميل أصلية للعناية بالبشرة والشعر في فلسطين.' }}
                </p>
                <div class="flex gap-3 justify-end">
                    @if(!empty($siteSettings['facebook_url']))<a href="{{ $siteSettings['facebook_url'] }}" target="_blank" class="w-9 h-9 rounded-full border flex items-center justify-center text-white/40 hover:text-white transition-all" style="border-color:var(--glass-border);" aria-label="واتساب"><i class="ph-fill ph-facebook-logo text-lg"></i></a>@endif
