...
<body class="antialiased" style="background-color: var(--surface); color: var(--ink);">
    ...
    <div class="floating-social-v3">
        @if(!empty($siteSettings['facebook_url']))<a href="{{ $siteSettings['facebook_url'] }}" style="background:#1877F2;" target="_blank" aria-label="فيسبوك"><i class="ph-fill ph-facebook-logo"></i></a>@endif
        @if(!empty($siteSettings['instagram_url']))<a href="{{ $siteSettings['instagram_url'] }}" style="background:linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888);" target="_blank" aria-label="إنستغرام"><i class="ph-fill ph-instagram-logo"></i></a>@endif
        @if(!empty($siteSettings['twitter_url']))<a href="{{ $siteSettings['twitter_url'] }}" style="background:#1DA1F2;" target="_blank" aria-label="تويتر"><i class="ph-fill ph-twitter-logo"></i></a>@endif
        @if(!empty($siteSettings['tiktok_url']))<a href="{{ $siteSettings['tiktok_url'] }}" style="background:#000;" target="_blank" aria-label="تيك توك"><i class="ph-fill ph-tiktok-logo"></i></a>@endif
        @if(!empty($siteSettings['linkedin_url']))<a href="{{ $siteSettings['linkedin_url'] }}" style="background:#0A66C2;" target="_blank" aria-label="لينكد إن"><i class="ph-fill ph-linkedin-logo"></i></a>@endif
        @if(!empty($siteSettings['youtube_url']))<a href="{{ $siteSettings['youtube_url'] }}" style="background:#FF0000;" target="_blank" aria-label="يوتيوب"><i class="ph-fill ph-youtube-logo"></i></a>@endif
        @if(!empty($siteSettings['whatsapp_number']))<a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $siteSettings['whatsapp_number']) }}" style="background:#25D366;" target="_blank" aria-label="واتساب"><i class="ph-fill ph-whatsapp-logo"></i></a>@endif
    </div>
