    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
            ...
            <div class="lg:col-span-4 text-right">
                ...
                <div class="flex gap-3 justify-end">
                    @if(!empty($siteSettings['facebook_url']))<a href="{{ $siteSettings['facebook_url'] }}" target="_blank" class="text-ink-dim hover:text-white transition-colors text-sm" aria-label="واتساب"><i class="ph-fill ph-facebook-logo text-lg"></i></a>@endif
                    @if(!empty($siteSettings['instagram_url']))<a href="{{ $siteSettings['instagram_url'] }}" target="_blank" class="text-ink-dim hover:text-white transition-colors text-sm" aria-label="انستغرام"><i class="ph-fill ph-instagram-logo text-lg"></i></a>@endif
            ...
            <div class="lg:col-span-2 text-right">
                ...
                <ul class="space-y-3 text-ink-dim text-sm">
                    <li><a href="{{ route('shipping-policy') }}" class="hover:text-white transition-colors">سياسة الخصوصية</a></li>
                    ...
                    <li><a href="{{ route('terms') }}" class="hover:text-white transition-colors">شروط الاستخدام</a></li>
                    ...
                    <li><a href="#" onclick="openSpinCodeEntry();return false;" class="hover:text-white transition-colors"><i class="ph-fill ph-gift" style="margin-left:4px;"></i>رمز الكوبون</a></li>
                </ul>
            </div>
        ...
        <div class="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-ink-dim" style="border-top:1px solid rgba(255,255,255,0.06);">
            ...
            <div class="flex gap-4">
                ...
                @if(!empty($siteSettings['instagram_url']))<a href="{{ $siteSettings['instagram_url'] }}" target="_blank" class="hover:text-white transition-colors">انستغرام</a>@endif
