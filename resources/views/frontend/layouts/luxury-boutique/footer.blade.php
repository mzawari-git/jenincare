...
<section class="py-16 relative" style="border-top:2px solid var(--glass-border);">
    <div class="max-w-4xl mx-auto px-4 text-center">
        ...
        <p class="text-ink-dim mb-8 max-w-lg mx-auto text-sm">احصلي على خصم 10% على أول طلبية عند الاشتراك في النشرة البريدية الحصرية.</p>
        <form class="max-w-md mx-auto relative flex items-center" id="newsletterFormV3">
            @csrf
            <input type="email" name="email" placeholder="أدخلي بريدك الإلكتروني" required class="w-full bg-transparent border border-white/10 text-white py-3.5 px-6 pl-28 rounded-full focus:outline-none focus:border-brand-500 transition-all text-sm placeholder:text-ink-dim">
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="flex flex-col items-center text-center p-5 rounded-2xl border" style="border-color:var(--glass-border);">
                ...
                <h3 class="font-bold text-white text-sm mb-1">ضمان 100%</h3>
                <p class="text-ink-dim text-xs">منتجات أصلية مضمونة</p>
            </div>
            <div class="flex flex-col items-center text-center p-5 rounded-2xl border" style="border-color:var(--glass-border);">
                ...
                <h3 class="font-bold text-white text-sm mb-1">شحن سريع وآمن</h3>
                <p class="text-ink-dim text-xs">توصيل لكل فلسطين</p>
            </div>
            <div class="flex flex-col items-center text-center p-5 rounded-2xl border" style="border-color:var(--glass-border);">
                ...
                <p class="text-ink-dim text-xs">مشفر بالكامل لحماية بياناتك</p>
            </div>
            <div class="flex flex-col items-center text-center p-5 rounded-2xl border" style="border-color:var(--glass-border);">
                ...
                <p class="text-ink-dim  ص - 10 م طوال الأسبوع</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
            ...
            <div class="lg:col-span-2 text-right">
                <h5 class="font-bold text-white mb-5 text-sm">تسوقي</h5>
            ...
            {{-- Support --}}
            <div class="lg:col-span-2 text-right">
                <h5 class="font-bold text-white mb-5 text-sm">روابط مهمة</h5>
                <ul class="space-y-3 text-ink-dim text-sm">
                    <li><a href="{{ route('shipping-policy') }}" class="hover:text-brand-500 transition-colors">سياسة الخصوصية</a></li>
                    ...
                    <li><a href="{{ route('terms') }}" class="hover:text-brand-500 transition-colors">شروط الاستخدام</a></li>
                    <li><a href="{{ route('privacy') }}" class="hover:text-brand-500 transition-colors">سياسة الخصوصية</a></li>
                    <li><a href="{{ route('contact') }}" class="hover:text-brand-500 transition-colors">اتصل بنا</a></li>
                    <li><a href="#" onclick="openSpinCodeEntry();return false;" class="hover:text-brand-500 transition-colors"><i class="ph-fill ph-gift" style="margin-left:4px;"></i>رمز الكوبون</a></li>
                </ul>
            </div>

            {{-- Contact --}}
            <div class="lg:col-span-4 text-right">
                <h5 class="font-bold text-white mb-5 text-sm">اتصل بنا</h5>
        ...
        <div class="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-ink-dim" style="border-top:2px solid var(--glass-border);">
            ...
            <div class="flex gap-2">
                ...
                @if(($siteSettings['payment_jawwal_enabled'] ?? '0') == '1')<span class="px-3 py-1 rounded-full text-brand-500" style="border:1px solid var(--glass-border);">جوال باي</span>@endif
            </div>
        </div>
    </div>
</footer>
