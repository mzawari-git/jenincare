...
<section class="py-16 relative" style="border-top:2px solid var(--glass-border);">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h2 class="text-2xl md:text-3xl font-black mb-3 text-white">انضمي إلى عالم <span class="text-brand-500">{{ $siteSettings['site_name'] ?? 'شركة جنين للتجميل' }}</span></h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
            ...
            <div class="lg:col-span-2 text-right">
                ...
                <ul class="space-y-3 text-ink-dim text-sm">
                    ...
                    <li><a href="#" onclick="openSpinCodeEntry();return false;" class="hover:text-brand-500 transition-colors"><i class="ph-fill ph-gift" style="margin-left:4px;"></i>كود دولب</a></li>
                </ul>
            </div>
