...
<div class="container py-5">
    <div class="text-center mb-5">
        ...
        <a href="{{ route('virtual-store.3d') }}" class="btn btn-lg btn-pink rounded-pill px-4 mt-2" style="background:linear-gradient(135deg,#8B5CF6,#6D28D9);border:none;">
            <i class="fas fa-cube ms-2"></i>
            جرب المتجر ثلاثي الأبعاد ✨
        </a>
    </div>
