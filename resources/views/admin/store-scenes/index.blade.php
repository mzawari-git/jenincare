        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $scene->section }}
                        @if($scene->{'3d_enabled'})
                        <span class="badge bg-purple ms-1" style="background:#8B5CF6;">3D</span>
                        @endif
                    </td>
                    <td>{{ $scene->aisle }}</td>
                    <td>
                    ...
                    <td class="text-end">
                        <a href="{{ route('admin.store-scenes.3d-objects', $scene) }}" class="btn btn-sm btn-outline-purple" title="كائنات ثلاثية الأبعاد" style="border-color:#8B5CF6;color:#8B5CF6;">
