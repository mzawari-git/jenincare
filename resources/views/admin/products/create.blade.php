...
@section('content')
<h1 class="h4 mb-4">إضافة منتج جديد</h1>
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.products.store') }}" method="POST">
                ...
                <div class="tab-pane fade show active" id="basic">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="main_image" class="form-control @error('main_image') is-invalid @enderror" value="{{ old('main_image') }}">
                ...
                <div class="tab-pane fade" id="pricing">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" step="0.01" name="b2c_price" class="form-control @error('b2c_price') is-invalid @enderror" value="{{ old('b2c_price') }}">
                            @error('b2c_price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">سعر الجملة (B2B)</label>
                            <input type="number" step="0.01" name="b2b_price" class="form-control @error('b2b_price') is-invalid @enderror" value="{{ old('b2b_price') }}">
                ...
                <div class="tab-pane fade" id="inventory">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="low_stock_alert" class="form-control" value="{{ old('low_stock_alert', 10) }}">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-12">
                            <div class="form-check form-switch d-inline-block me-3">
                                <input type="checkbox" name="track_inventory" class="form-check-input" value="1" id="track_inv" checked>
                                <label class="form-check-label" for="track_inv">تتبع المخزون</label>
                            </div>
                            <div class="form-check form-switch d-inline-block">
                                <input type="checkbox" name="allow_backorder" class="form-check-input" value="1" id="allow_bo">
                ...
                <div class="tab-pane fade" id="seo">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title') }}" maxlength="160" placeholder="اسم المنتج - التصنيف | JeninCare">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-bold">Meta Description</label>
                            <textarea name="meta_description" class="form-control" rows="2" maxlength="320" placeholder="وصف مختصر للمنتج...">{{ old('meta_description') }}</textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-bold">الكلمات المفتاحية</label>
                            <input type="text" name="meta_keywords" class="form-control" value="{{ old('meta_keywords') }}" placeholder="كلمة1, كلمة2, كلمة3...">
                        </div>
                        <div class="col-12">
                            <label class="form-label fw-bold">رابط صورة OG</label>
                            <input type="text" name="og_image" class="form-control" value="{{ old('og_image') }}" placeholder="https://...">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-12">
                    <div class="form-check form-switch d-inline-block me-3">
                        <input type="checkbox" name="status" class="form-check-input" value="active" id="status" checked>
                    ...
                    <div class="form-check form-switch d-inline-block me-3">
                        <input type="checkbox" name="is_new" class="form-check-input" value="1" id="is_new">
